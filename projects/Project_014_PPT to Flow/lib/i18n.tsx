...
export const translations = {
  en: {
    ...
    "placeholder.vehicles.title": "Vehicles",
    "placeholder.vehicles.description": "Document vehicle models, angles, finishes, interiors, badges, and forbidden variations.",
  ...
  "zh-TW": {
    ...
    "placeholder.vehicles.title": "車輛",
    "placeholder.vehicles.description": "記錄車型、角度、材質、內裝、徽標，以及不可出現的變體。",
