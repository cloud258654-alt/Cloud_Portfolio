    ...
    return (
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-base font-bold text-gray-800">高風險事件</h3>
          <span className="bg-green-50 text-green-600 text-xs font-semibold px-2.5 py-1 rounded-full">無風險事件</span>
        </div>
        <div className="py-8 text-center text-gray-400 text-sm">目前沒有高風險輿情事件</div>
      </div>
    );
  }
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-2 mb-1">
                  <span className="font-semibold text-gray-800 text-sm">{m.title || '無標題'}</span>
                ...
                <div className="flex items-center justify-between mt-2.5">
                  <div className="flex items-center gap-2 text-xs text-gray-400">
                    ...
                    {m.keyword_name && <span>關鍵字: {m.keyword_name}</span>}
