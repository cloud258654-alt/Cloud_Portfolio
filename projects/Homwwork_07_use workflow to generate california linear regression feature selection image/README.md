...
- **[boston_housing.csv](./boston_housing.csv)**: The primary Boston Housing dataset containing 506 rows and 14 columns.
- **[linear_regression_model.pkl](./linear_regression_model.pkl)**: Serialized final pipeline model (refitted on all 506 samples using the optimal features).
...
- **[hw7.md](./hw7.md)**: A concise homework summary report of today's work and results.
